  ...
  render() {
    ...
    return (
      <div className="settings-block">
        <p className="nextart-600 settings-header">Настройки</p>
        <ul className="list-reset settings-list flex">
          ...
          <li className="settings-item flex">
            ...
            <div className="change-plan flex">
              <input
                className="settings-input plan-input"
                placeholder={
        ...
        <button className="door btn-reset flex" onClick={this.handleLogoutClick}>
          <svg
            width="53"
            height="59"
            viewBox="0 0 53 59"
