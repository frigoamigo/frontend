    ...
    return(
        ...
        <ul>
            <li className="premium-cards-list">
                <div className="premium-card-box" style={{border: `${props.btnBorder}`, boxShadow: `${props.shadow}`, backgroundColor: `${props.bgColor}`}}>
                    <div className="premium-card-heading nextart-400" style={{color: `${props.colorTime}`, marginTop: `${props.margin}`}}>{props.time}</div>
                    <div className="premium-card-price nextart-400" >{props.priceMonth}</div>
                    <button className="premium-btn premium-btn-hover color" style={{backgroundImage: `${props.btnColor}`, border: `${props.btnBorder}`}}>
                        <div className="manrope-500 premium-btn-text premium-btn-items" style={{color: `${props.color}`}}>{props.priceTotal}</div>  
