            ...
            <div className='users-block flex'>
                ...
                <ul className='users-list'>
                    <li className='users-item'>
                        ...
                        <svg className='admin-crown' width="24" height="24" viewBox="0 0 24 24" fill="none"
                    ...
                    this.showMakeUserAdminConfirmation && (
                        <div className='confirmation-modal flex'>
                            <p className='confirmation-text manrope-400'>Вы уверены, что хотите сделать
                                ...
                                администраторов.</p>
                            <div className='confirmation-buttons flex'>
                                <button className='btn-reset conf-btn manrope-700' onClick={this.confirmAdmin}>Да</button>
                                <button className='btn-reset conf-btn manrope-700' onClick={this.cancelAdmin}>Отмена</button>
                            </div>
                        </div>
                    )
                }
                <div className='to-edit-div'>
                    {this.isEditMode ? (
                        <>
                            ...
                            <button onClick={this.handleCancelEdit} className='to-edit delete-fridge btn-reset nextart-400'>
                                Удалить холодильник
                            </button>
                        </>
                    ) : (
